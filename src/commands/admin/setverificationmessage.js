...
module.exports = class SetVerificationMessageCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['verificationmsg', 'v-m', 'vm'],
      usage: 'verificationmessage <message>',
      description: oneLine`
        Sets the message Unicron will post in the \`verification channel\`.
      ...
      examples: ['verificationmessage Please read the server rules, then react to this message.']
    });
  }
