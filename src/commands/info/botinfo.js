...
module.exports = class BotInfoCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['bot', 'bi'],
      usage: 'botinfo',
      description: 'Fetches Unicron\'s bot information.',
  ...
  run(message) {
    ...
    const tech = stripIndent`
      ...
      Environment :: Node.js v14.10.3
      Database    :: SQLite
    `;
    const embed = new MessageEmbed()
      .setTitle('Unicron\'s Bot Information')
      .setDescription(oneLine`
        Unicron is a multipurpose bot which has 180+ commands and enhance all fiscord server.
        ...
        She first went live on **Mar 10nd, 2021**.
      `)
      ...
      .setImage('https://i.pinimg.com/originals/7d/c8/ac/7dc8ac1c164ac5b0076f0c49e60b9aa1')
