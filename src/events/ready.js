module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`Unicron has left ${guild.guild_name}`);
  }

  client.logger.info('Unicron is now online');
  client.logger.info(`Unicron is running on ${client.guilds.cache.size} server(s)`);
};
